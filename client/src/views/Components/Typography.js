    ...
    <Container fluid>
      <Row>
        <Col md={12}>
          <Card>
            <Card.Body>
              <Card.Title>Light Bootstrap Table Headinge</Card.Title>
              <Card.Subtitle className="mb-2 text-muted">Created using Roboto Font Family</Card.Subtitle>
              <div>
                ...
                <div className="typo-line">
                  <p>
                    <span className="category">Paragraph</span>Lorem ipsum dolor sit amet, consectetuer adipiscing elit,
